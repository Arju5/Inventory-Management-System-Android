...
//For Disbursement Lists
        ...
        Call<DelegationViewModel> getEmployeeListForDelegate(@Query("id") Integer id);


        @POST("delegation/SaveEmpDepHead")
        Call<DelegationViewModel> SaveEmpDepHead(@Body DelegationViewModel dvm);
